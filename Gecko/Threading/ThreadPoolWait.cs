...
namespace Gecko.Threading
{
	/// <summary>
	/// ThreadPool utility class that allows for easily waiting on queued delegates.
	/// </summary>
	public class ThreadPoolWait : IDisposable
	{
		/// <summary>
		/// Number of items remaining to be executed.
		/// </summary>
		...
		/// <summary>
		/// Decrements the number of remaining items, signaling the ManualResetEvent if 0 are left.
		/// </summary>
		...
		/// <summary>
		/// State class that wraps a WaitCallback and the state object to be passed to it.
		/// </summary>
		private class QueuedCallback
		{
			/// <summary>
			/// A callback delegate queued to the ThreadPool.
			/// </summary>
